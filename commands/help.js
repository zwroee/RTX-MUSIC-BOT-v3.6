  ...
  run: async (client, interaction) => {
    try {
      ...
      const basicCommandsEmbed = new EmbedBuilder()
       ...
       .setImage('https://images-ext-1.discordapp.net/external/G-D4P3LNClA-tqIADLG4tadGdaK2QbkjJX0icHtF08A/https/media.tenor.com/Acm71RTQlswAAAPo/alucard-luka.mp4')
